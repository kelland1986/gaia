...
/*******************************************************************************
 * NfcManagerUtil offers a set of utility functions to handle NDEF messages
...
var NfcManagerUtil = {
  ...
  doParseHandoverNDEF: function doParseHandoverNDEF(ndefMsg) {
    ...
    var buffer = NfcUtil.createBuffer(record.payload);
    var h = {};
    ...
    var embeddedNdef = NfcUtil.parseNDEF(buffer);
  ...
  parseBluetoothSSP: function parseBluetoothSSP(cdr) {
    var btssp = {};
    var buf = NfcUtil.createBuffer(cdr.payload);
